...
SECRET_KEY = 'django-insecure-7w5c2onsa&z3qdbm^ivykx0n7vr4@r&_p6c8_s1-vuq7^b5q*8'
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'server.utils.custom_error_handler',
    'EXCEPTION_RENDERER_CLASSES': (
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:8000", # АДРЕС НА ПРОДЕ ПОМЕНЯТЬ
]

ROOT_URLCONF = 'quizgameserver.urls'
...
WSGI_APPLICATION = 'quizgameserver.wsgi.application'
